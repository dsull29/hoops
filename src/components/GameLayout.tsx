...
export const GameLayout: React.FC<GameLayoutProps> = ({ children, isDarkMode, onThemeChange }) => (
  <Layout style={{ minHeight: '100vh' }}>
    {' '}
    {/* This ensures the layout itself tries to fill the viewport height */}
    <Header
      style={{
        display: 'flex',
        alignItems: 'center',
    ...
    */}
    <Content style={{ padding: '24px', marginTop: 0 }}>
      {' '}
      {/* Resetting marginTop, sticky header should manage space */}
      <div style={{ padding: '24px 0', borderRadius: 8, maxWidth: 960, margin: '0 auto' }}>
        {' '}
        {/* Adjusted padding for content wrapper */}
        {children}
      </div>
    </Content>
